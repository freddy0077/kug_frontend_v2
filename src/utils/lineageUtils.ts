    ...
    const mockCommonAncestors: CommonAncestor[] = [
      {
        dog: {
          ...
          dateOfBirth: '2016-01-15',  // Using string format as required by PedigreeNode interface
          isChampion: true,
          healthTested: true,
          color: 'Black',
      ...
      },
      {
        dog: {
          ...
          dateOfBirth: '2016-06-30',  // Using string format as required by PedigreeNode interface
          isChampion: false,
          healthTested: true,
          color: 'Black',
      ...
      },
      {
        dog: {
          ...
          dateOfBirth: '2014-03-12',  // Using string format as required by PedigreeNode interface
          isChampion: true,
          healthTested: true,
          color: 'Yellow',
