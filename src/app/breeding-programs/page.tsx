...
export default function BreedingPrograms() {
  ...
  // Sample breeding program data
  const breedingPrograms = [
    {
      id: 1,
      name: "Champion Line Labradors",
      description: "Breeding for health and temperament excellence in Labrador Retrievers.",
    ...
    {
      id: 2,
      name: "Royal German Shepherds",
      description: "Focused on maintaining the working abilities of German Shepherds with excellent health.",
    ...
    {
      id: 3,
      name: "Golden Temperament",
      description: "Breeding Golden Retrievers with emphasis on family-friendly temperament.",
  ...
  useEffect(() => {
    ...
    // Redirect if not authenticated or not a breeder/admin
    if (!authStatus) {
      router.push('/auth/login');
    } else if (role !== 'breeder' && role !== 'admin') {
  ...
  if (!isAuthenticated || (userRole !== 'breeder' && userRole !== 'admin')) {
            ...
            >
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-1 mb-4">
                  {program.breeds.map((breed, index) => (
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-gray-500">Active Litters</p>
                    <p className="font-semibold">{program.activeLitters}</p>
                  </div>
                  <div>
                    <p className="text-gray-500">Total Dogs</p>
                    <p className="font-semibold">{program.totalDogs}</p>
                  </div>
                </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <Link 
                href="/resources/genetic-calculator"
