...
export default function RegisterNewLitterPage() {
  const router = useRouter();
  const { user, loading } = useAuth();
  
  // Handle successful litter registration
  const handleSuccess = (litterId: string) => {
  ...
  if (!user) {
    if (typeof window !== 'undefined') {
      router.push('/auth/login?redirect=/litters/new');
    }
    return null;
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-sm font-medium text-gray-500">Register New Litter</span>
                </div>
              </li>
            </ol>
          </nav>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-gray-900">Register New Litter</h1>
            <Link
              href="/litters"
          ...
          <p className="mt-2 text-sm text-gray-500">
            Register a new litter and track information about puppies.
          </p>
        </div>
