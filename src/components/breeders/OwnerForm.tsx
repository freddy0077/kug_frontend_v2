...
const OwnerForm: React.FC<OwnerFormProps> = ({ mode, ownerId }) => {
  ...
  const createUserWithOwner = async (userData: any) => {
    ...
    try {
      ...
      router.push('/admin/manage-owners');
    } catch (error: any) {
  ...
  // Placeholders will be defined below
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const ownerInput = {
      ...
      breedingPhilosophy: formData.breedingPhilosophy || undefined
    };
  ...
  // Placeholder for mutation hooks until actual mutations are implemented
  const [createOwner, { loading: createLoading }] = [() => {}, { loading: false }] as any;
  const [updateOwner, { loading: updateLoading }] = [() => {}, { loading: false }] as any;
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* Breeding Philosophy textarea */}
                <div className="col-span-2">
                  <label htmlFor="breedingPhilosophy" className="block text-sm font-medium text-gray-700 mb-1">
                    Breeding Philosophy
                  </label>
                  <textarea
                    id="breedingPhilosophy"
                    name="breedingPhilosophy"
                    rows={3}
                    value={formData.breedingPhilosophy || ''}
                    onChange={handleChange}
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                    placeholder="Describe the owner's approach and philosophy to dog care and breeding"
                  />
                </div>
              </div>
            </div>
