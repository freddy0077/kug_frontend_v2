    ...
    <footer className="bg-gray-900 text-gray-300 py-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-bold mb-4">Pedigree Database</h3>
            <p className="text-sm">
              A comprehensive platform for tracking and managing dog pedigrees, health records, and breeding information.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/dogs" className="hover:text-green-400 transition">Dogs</Link></li>
              <li><Link href="/breeds" className="hover:text-green-400 transition">Breeds</Link></li>
              <li><Link href="/pedigrees" className="hover:text-green-400 transition">Pedigrees</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-sm">Email: info@kennelunionghana.com</p>
          </div>
        </div>
        
        <div className="border-t border-gray-800 mt-10 pt-6 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} Pedigree Database. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
